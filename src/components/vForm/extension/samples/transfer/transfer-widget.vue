<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <el-transfer ref="fieldEditor" v-model="fieldModel" v-show="!isReadMode" class="full-width-input"
              ...
              :titles="[field.options.leftTitle,field.options.rightTitle]"
               :remote="field.options.remote" :remote-method="remoteQuery"
               @focus="handleFocusCustomEvent" @blur="handleBlurCustomEvent"
               @change="handleChangeEvent">
    </el-transfer>
    <template v-if="isReadMode">
      <span class="readonly-mode-field">{{getTransferOptionLabel}}</span>
    </template>
  </form-item-wrapper>
</template>

<script>
  import FormItemWrapper from '@vForm/form-designer/form-widget/field-widget/form-item-wrapper'
