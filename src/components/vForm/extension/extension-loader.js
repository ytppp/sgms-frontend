...
} from '@vForm/form-designer/widget-panel/widgetsConfig'
import * as PERegister from '@vForm/form-designer/setting-panel/propertyRegister'
import * as PEFactory from '@vForm/form-designer/setting-panel/property-editor-factory.jsx'
...
import {transferSchema} from "@vForm/extension/samples/extension-schema"
import TransferWidget from '@vForm/extension/samples/transfer/transfer-widget'
// import {registerFWGenerator} from '@vForm/utils/sfc-generator'
import {transferTemplateGenerator} from '@vForm/extension/samples/extension-sfc-generator'
...
export const loadExtension = function (app) {
  ...
  addCustomWidgetSchema(transferSchema)  //加载组件Json Schema
  /* -------------------------------------------------- */
  app.component(TransferWidget.name, TransferWidget)  //注册组件

  PERegister.registerCPEditor(app, 'leftTitle', 'left-title-editor',
      PEFactory.createInputTextEditor('leftTitle', 'extension.setting.leftTitle'))

  PERegister.registerCPEditor(app, 'rightTitle', 'right-title-editor',
      PEFactory.createInputTextEditor('rightTitle', 'extension.setting.rightTitle'))
