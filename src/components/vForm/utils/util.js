 ...
 * @LastEditTime: 2023-03-25 12:08:58
 * @FilePath: \vform\src\utils\util.js
...
export function translateOptionItems(rawData, widgetType, labelKey, valueKey) {
  ...
  if (widgetType === 'tree-select' || widgetType === 'transfer' || widgetType === 'tree') { // 树选择框 不转译
