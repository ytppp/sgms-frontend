...
const COMMON_PROPERTIES = {
  ...
  // FYCDC-Germ增加  
  'defaultExpandAll'   :            'defaultExpandAll-editor',
  'checkAllable'       :            'checkAllable-editor',
  'expandAllable'      :            'expandAllable-editor',
  'expandOnClickNode'  :            'expandOnClickNode-editor',
  'showCheckBox'       :            'showCheckBox-editor',
  'showDiv'			       :	        	'showDiv-editor',
}
