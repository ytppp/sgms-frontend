...
<script>
  ...
  import OptionItemsSetting from '@vForm/form-designer/setting-panel/option-items-setting'
  import propertyMixin from '@vForm/form-designer/setting-panel/property-editor/propertyMixin'
  import {getDSByName} from '@vForm/utils/util'
