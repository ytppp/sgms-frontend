<template>
  <div class="panel-tab__content">
    <el-table :data="elementListenersList">
      ...
      <el-table-column label="操作">
        <template #default="scope">
          ...
          <el-button type="danger" @click="removeListener(scope.row, scope.$index)"
            >移除</el-button
          >
        </template>
      </el-table-column>
    ...
    >
              ...
              <el-tooltip placement="top">
                <template #content>
                  <div>
                    ...
                    <br />assignment（指派）：当任务已经指派给某人时触发。请注意：当流程执行到达用户任务时，
                    <br />
                    在触发create事件之前，会首先触发assignment事件。这顺序看起来不太自然， <br />
      ...
      <el-table :data="fieldsListOfListener" max-height="240" fit style="flex: none">
        <el-table-column label="序号" width="50px" type="index" />
