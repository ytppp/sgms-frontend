<template>
  <div class="panel-tab__content">
    ...
    <el-table :data="elementButtonList" max-height="240" fit>
    ...
    >
      ...
      <template #footer>
        <el-button @click="buttonFormModelVisible = false">取 消</el-button>
  ...
  methods: {
    ...
    saveAttribute() {
      ...
      if (this.editingPropertyIndex !== -1) {
        ...
        // 新建属性字段
        const newPropertyObject = this.modelerStore.moddle.create(`flowable:Button`, {
          name,
          value,
        })
        // 新建一个属性字段的保存列表
