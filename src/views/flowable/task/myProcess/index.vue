<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="myProcessList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="办理人" align="center">
        <template #default="scope">
          <label v-if="scope.row.assigneeName"
            ...
            <el-tag type="info">{{ scope.row.assigneeDeptName }}</el-tag></label
          >
      ...
      >
        <template #default="scope">
          <el-button @click="handleFlowRecord(scope.row)" link type="primary">详情</el-button>
          <el-button @click="handleStop(scope.row)" link type="primary">取消申请</el-button>
          <el-button
    ...
    <el-dialog :title="title" v-model="open" width="60%" append-to-body>
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" icon="Search" @click="handleProcessQuery"
            >搜索</el-button
          >
